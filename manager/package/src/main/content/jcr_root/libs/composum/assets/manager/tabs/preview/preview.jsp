...
<cpn:component id="model" type="com.composum.assets.commons.widget.Thumbnail">
    <div class="detail-panel ${model.key}" data-path="${model.path}">
        <div class="detail-tabs action-bar btn-toolbar" role="toolbar">
            ...
            <div class="btn-group btn-group-sm" role="group">
                <a class="general ${model.iconCss} btn btn-default" href="#general" data-group="general"
                   title="Preview"><span class="label">Preview</span></a>
            </div>
        </div>
