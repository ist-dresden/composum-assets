...
(function (window) {
    ...
    (function (assets, core) {
        ...
        assets.ConfigTab = assets.FolderTab.extend({

            initialize: function (options) {
                var c = assets.const.config.edit;
                assets.FolderTab.prototype.initialize.apply(this, [options]);
            ...
            initContent: function () {
                var c = assets.const.config.edit;
                assets.FolderTab.prototype.initContent.apply(this, [this.$content]);
                this.initSelectors();
