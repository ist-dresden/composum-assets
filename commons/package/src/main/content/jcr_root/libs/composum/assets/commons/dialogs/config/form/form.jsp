                ...
                <div class="panel-heading">
                    <h2 class="panel-title">
                        <a data-toggle="collapse" data-parent="#asset-config-form-aspects"
                           data-child="#asset-config-form-aspect-file">${cpn:i18n(slingRequest,'Category / File / Example')}</a>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                <div class="widget multi-form-widget form-group" data-name="category">
                                    <cpn:text tagName="label" tagClass="control-label" value="Category"
                                              i18n="true"/>
                                    <input type="hidden" name="category@TypeHint" value="String[]" />
                                    <div class="multi-form-content">
                                        <div class="multi-form-item">
                                            <input class="widget mixin-type-widget form-control" type="text" name="category"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
