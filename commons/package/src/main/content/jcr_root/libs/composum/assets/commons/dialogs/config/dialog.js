        ...
        assets.const.config.dialog = {
            ...
            css: {
                ...
                general: {
                    ...
                    category: '.multi-form-widget[data-name="category"]'
                },
                file: {
                    jpg: {
        ...
        assets.AssetConfigDialog = core.components.Dialog.extend({
            ...
            initialize: function (options) {
                ...
                this.general = {
                    ...
                    category: core.getWidget(this.el, c.css.general.category, core.components.MultiFormWidget)
                };
                this.file = {
                ...
                if (path) {
                    ...
                    core.getJson('/bin/cpm/assets/assets.config.json' + path,
                        _.bind(function (result) {
                            ...
                            this.general.category.setValue(this.data.category);
