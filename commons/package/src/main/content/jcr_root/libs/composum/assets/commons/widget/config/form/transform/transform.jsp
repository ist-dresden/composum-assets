...
<cpn:component var="model" type="com.composum.assets.commons.widget.ConfigModel" scope="request">
    ...
    <div class="row">
        <div class="col col-xs-3">
            <div class="form-group">
                <input type="hidden" name="size_width@Delete" value="true"/>
        ...
        <div class="col col-xs-3">
            <div class="form-group">
                <input type="hidden" name="size_height@Delete" value="true"/>
        ...
        <div class="col col-xs-3">
            <div class="form-group">
                <input type="hidden" name="size_aspectRatio@Delete" value="true"/>
    ...
    <div class="row">
        <div class="col col-xs-3">
            <div class="form-group">
                <input type="hidden" name="crop_vertical@Delete" value="true"/>
        ...
        <div class="col col-xs-3">
            <div class="form-group">
                <input type="hidden" name="crop_horizontal@Delete" value="true"/>
        ...
        <div class="col col-xs-3">
            <div class="form-group">
                <input type="hidden" name="crop_scale@Delete" value="true"/>
    ...
    <div class="row">
        <div class="col col-xs-3">
            <div class="form-group">
                <input type="hidden" name="transformation_blur_factor@Delete" value="true"/>
