...
<cpn:component var="model" type="com.composum.assets.commons.widget.FolderModel" scope="request">
    <div class="composum-assets-widget-navigator-browse_toolbar btn-toolbar panel-heading" role="toolbar">
        ...
        <div class="composum-assets-widget-navigator-browse_folder-title">${cpn:text(model.path)}</div>
