...
<cpn:component var="model" type="com.composum.assets.commons.widget.FolderModel" scope="request">
    <div class="composum-assets-widget-navigator_view-type-keys btn-group btn-group-sm" role="group">
        <a class="composum-assets-widget-navigator_view-type fa fa-th btn btn-default${model.viewType=='small'?' active':''}"
        ...
        <a class="composum-assets-widget-navigator_view-type fa fa-th-large btn btn-default${model.viewType=='large'?' active':''}"
        ...
        <a class="composum-assets-widget-navigator_view-type fa fa-th-list btn btn-default${model.viewType=='list'?' active':''}"
