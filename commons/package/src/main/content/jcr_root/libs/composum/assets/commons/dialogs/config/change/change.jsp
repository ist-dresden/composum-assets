...
<cpn:component var="model" type="com.composum.assets.commons.widget.ConfigModel" scope="request">
    <div class="composum-assets-dialogs-config-change dialog modal fade" role="dialog" aria-hidden="true">
        <div class="composum-assets-dialogs-config modal-dialog">
            <div class="composum-assets-widget-config-form modal-content form-panel default">
                <cpn:form action="${model.actionUrl}" method="POST"
                          ...
                          class="composum-assets-dialogs-config_form composum-assets-widget-config-form_form widget-form">
