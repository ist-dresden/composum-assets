...
<cpn:component id="model" type="com.composum.assets.commons.widget.FolderModel">
    <div class="composum-assets-widget-navigator-browse_subfolders">
        <c:forEach items="${model.subfolders}" var="subfolder">
            <div class="composum-assets-widget-navigator-browse_subfolders-item panel panel-default accordion-item widget">
                <div class="panel-heading">
                    <div class="head-actions btn-toolbar">
                        <div class="btn-group btn-group-sm" role="group">
                            <button type="button" class="composum-assets-widget-navigator_drill-down fa fa-folder-open-o text-muted btn btn-default"
                ...
                <div id="sub_${subfolder.domId}" role="tabpanel"
                     class="composum-assets-widget-navigator-browse_subfolder panel-collapse collapse in">
                    <div class="panel-body">
                        <div class="panel-group">
                            <c:set var="model" value="${subfolder}" scope="request"/>
                            <sling:include path="${cpn:path(subfolder.path)}"
                                           resourceType="composum/assets/commons/widget/navigator/content"/>
                        </div>
                    </div>
                </div>
            </div>
